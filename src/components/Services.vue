...
<!--      <table class="elz elzTable w100p mT16 va-M fn-9 lh-12 r3 bsh-default1 uStripInner stripLD borNoneInner   bg bg-primary bgL5    stripSelInnerCol4">
    ...
    <div class="d-block hideSelOut5 showSelOut5 pB16"><!--СЮДА ДОБАВИТЬ КЛАСС sel ЧТОБЫ ОНО ОТКРЫВАЛОСЬ, И УБРАТЬ, ЧТОБЫ ЗАКРЫВАЛОСЬ -->
      <div class="elz pH16">
        <div class="elz d-flex a-H p16 r3 cur-pointer fn-9 bg bg-secondary bgHovL5 fn fn-secondary-t opAct07" title="Показать завершенные контракты">
